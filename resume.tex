...
\TwoColBox{white}{
	...
	\begin{itemize}
		...
		\item Assoc. Prof. Miriam Zacksenhouse (Technion), +972-54-5820404, \href{mailto:mermz@technion.ac.il}{mermz@technion.ac.il}
%		\item Assoc. Prof. Yizhar Or (Technion), +972-77-8875493, izi@technion.ac.il
		\item Lauri Viitas (Guzik), +1-650-625-8000, \href{mailto:lauriv@guzik.com}{lauriv@guzik.com}
	\end{itemize}
}
