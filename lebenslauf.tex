...
\MainContent{white}{
	...
	\fi
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\section*{Ausbildung}%Schulbildung
	\subsection*{Studium}%Schulbildung
	\DiplomaEntry{%
	...
	\textbf{Bachelor-Projekt: Robotics Simulation Environment (ROSIE)}%
	\begin{itemize}
	...
	\end{itemize}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\subsection*{Stipendien und Auszeichnungen}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\subsection*{Publikationen}%Liste der 
	...
	\section*{Zusatzqualifikationen}%F{\"a}higkeiten und 
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\section*{Interesse}
	Startups, Aktienmarkt, Sci-Fi. %Wandern
...
%	\hspace*{0.5cm}\includegraphics[width=3cm]{signature}
	\begin{flushright}
		\includegraphics[width=3cm]{signature}\hspace*{3cm}\\
